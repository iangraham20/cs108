...
class Quiz:
    ...
    def __init__(self):
        ...
        self.problems.append(ShortAnswer('Who was the thirty-fourth president of the United States', 'Dwight D. Eisenhower'))
        self.problems.append(FillInTheBlank('Dibble means to ________ like a duck', 'drink'))
        self.problems.append(TrueFalse('Fall 2014 was short', True))
        self.problems.append(TrueFalse('Stalefish is a term used in snowboarding', True))
